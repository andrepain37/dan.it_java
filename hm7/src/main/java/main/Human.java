...
abstract public class Human {
    ...
    public boolean equals(Object o) {
        ...
        Human human = (Human) o;
        return iq == human.iq && Objects.equals(schedule, human.schedule) && Objects.equals(family, human.family);
    }

    @Override
    public int hashCode() {
        return Objects.hash(iq, schedule, family);
    }
    ...
    public Human(String name, String surname, int year, byte iq, Map<String, String> schedule, Family family){
        this.name = name;
