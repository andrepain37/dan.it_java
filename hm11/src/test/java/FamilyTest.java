...
class FamilyTest {
    ...
    void testToString() {
        Man h1 = new Man("Pieter", "Parker", "01/01/1970", (byte) 0);
        Woman m1 = new Woman("Mary", "Jane", "01/01/1970", (byte) 0);

        Family f1 = new Family(h1, m1);
        String expected = "Family{ mother='Human{ name='Pieter', surname=Parker, birthDate=01/01/1970, iq=0, schedule=null}', father=Human{ name='Mary', surname=Jane, birthDate=01/01/1970, iq=0, schedule=null}, children=[], pet=null}";
    ...
    void testDeleteChild() {
        ...
        String realDelete = f1.getChildren().toString();
    ...
    void testAddChild() {
        ...
        int expCountChilds = 1;

        String realChildren = f1.getChildren().toString();
        int realCountChilds = f1.getChildren().size();

        assertEquals(expChildren, realChildren);
        assertEquals(expCountChilds, realCountChilds);
    }
